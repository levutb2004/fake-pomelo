...
# Define root path
root_path = 'F:/pomelo/population_estimation-main/pomelo_input_data/'
...
input_paths = {
    "vnm": {
        ...
        "vnm_elevation_2019": f"{root_path}VNM/covariates/vnm_elevation_merit103_100m_v1.tif",
        #"vnm_dst_bsgme_100m_2019": f"{root_path}VNM/covariates/vnm_dst_bsgme_100m_2019.tif",
        #"vnm_dst_ghslesaccilcgufghsll_100m_2014": f"{root_path}VNM/covariates/vnm_dst_ghslesaccilcgufghsll_100m_2014.tif",
        #"vnm_dst_coastline_100m_2000_2020": f"{root_path}VNM/covariates/vnm_dst_coastline_100m_2000_2020.tif",
        #"vnm_dmsp_100m_2011": f"{root_path}VNM/covariates/vnm_dmsp_100m_2011.tif",
        #"vnm_esaccilc_dst_water_100m_2000_2012": f"{root_path}VNM/covariates/vnm_esaccilc_dst_water_100m_2000_2012.tif",
        #"vnm_osm_dst_roadintersec_100m_2016": f"{root_path}VNM/covariates/vnm_osm_dst_roadintersec_100m_2016.tif",
        #"vnm_osm_dst_waterway_100m_2016": f"{root_path}VNM/covariates/vnm_osm_dst_waterway_100m_2016.tif",
        #"vnm_osm_dst_road_100m_2016": f"{root_path}VNM/covariates/vnm_osm_dst_road_100m_2016.tif",
        #"vnm_srtm_slope_100m": f"{root_path}VNM/covariates/vnm_srtm_slope_100m.tif",
        #"vnm_srtm_topo_100m": f"{root_path}VNM/covariates/vnm_srtm_topo_100m.tif",
        "vnm_viirs_100m_2019": f"{root_path}VNM/covariates/vnm_viirs_nvf_2019_100m_v1.tif",
        #"vnm_wdpa_dst_cat1_100m_2015": f"{root_path}VNM/covariates/vnm_wdpa_dst_cat1_100m_2015.tif"
    },
    "tza": {
...
no_data_values = {
    "vnm": {
        ...
        "vnm_elevation_2019": -999999,
        "vnm_viirs_100m_2019": -999999
    },
    "tza": {
        "buildings_j": None,
...
norms = {
    "vnm": {
        ...
        "vnm_elevation_2019": (698.8104,  326.6751),
        "vnm_viirs_100m_2019": (71.8836 ,  399.8602 ),
